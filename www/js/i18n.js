...
window.I18N = (function () {
  const en = {
    ...
    "st.bestThirds": "Best 3rd-Placed", "st.qualifies": "Qualifies", "ko.tab": "Knockout", "ko.groups": "Groups", "ko.empty": "The bracket appears once the group stage is decided.", "ko.provisional": "Provisional — based on current group standings.",
    "profile.title": "Profile", "profile.logout": "Logout",
    "profile.changeName": "Change username", "profile.changePhoto": "Change photo", "profile.theme": "Theme", "profile.share": "Share", "profile.shareHint": "Long-press the image to save or share it.",
    ...
    "stat.totalPoints": "Total Points", "stat.exact": "Exact", "stat.difference": "Goal Diff", "stat.outcomes": "Outcomes", "stat.hitRate": "Hit Rate", "stat.pts4": "(4 pts)",
    ...
    "champ.actual": "Actual champion:", "champ.correct": "Correct — bonus earned! 🏆", "champ.wrong": "Wrong pick.", "champ.race": "Champion Race",
    ...
    "comm2.post": "Post", "comm2.empty": "No posts yet. Be the first!", "comm2.comments": "comments", "comm2.addComment": "Add a comment…", "comm2.new": "New", "comm2.top": "Top", "comm2.editL": "Edit", "comm2.report": "Report", "comm2.reported": "Reported", "comm2.save": "Save", "comm2.reply": "Reply",
  };
  const fr = {
    appName: "HAMA WC 2026",
    ...
    "st.bestThirds": "Meilleurs 3es", "st.qualifies": "Qualifié", "ko.tab": "Phase finale", "ko.groups": "Groupes", "ko.empty": "Le tableau apparaît après la phase de groupes.", "ko.provisional": "Provisoire — d après le classement actuel.",
    "profile.title": "Profil", "profile.logout": "Déconnexion",
    "profile.changeName": "Changer le nom", "profile.changePhoto": "Changer la photo", "profile.theme": "Thème", "profile.share": "Partager", "profile.shareHint": "Appui long sur l'image pour l'enregistrer ou la partager.",
    ...
    "stat.totalPoints": "Points", "stat.exact": "Exacts", "stat.difference": "Différence", "stat.outcomes": "Résultats", "stat.hitRate": "Réussite", "stat.pts4": "(4 pts)",
    ...
    "champ.actual": "Champion réel :", "champ.correct": "Correct — bonus ! 🏆", "champ.wrong": "Mauvais choix.", "champ.race": "Course au titre",
    "ach.title": "Succès", "ach.firstPick": "Premier pronostic", "ach.sharp": "Tireur", "ach.hattrick": "Coup du chapeau", "ach.streak3": "En feu (×3)", "ach.century": "Centurion", "ach.veteran": "Vétéran", "ach.oracle": "Oracle",
    "ach.firstPickD": "Faites votre premier pronostic.", "ach.sharpD": "Trouvez un score exact.", "ach.hattrickD": "Obtenez 3 scores exacts.", "ach.streak3D": "Marquez sur 3 pronostics d'affilée.", "ach.centuryD": "Atteignez 100 points.", "ach.veteranD": "Faites 20 pronostics.", "ach.oracleD": "Pronostiquez le bon champion.",
    ...
    "comm2.post": "Publier", "comm2.empty": "Aucune publication. Soyez le premier !", "comm2.comments": "commentaires", "comm2.addComment": "Ajouter un commentaire…", "comm2.new": "Nouveau", "comm2.top": "Top", "comm2.editL": "Modifier", "comm2.report": "Signaler", "comm2.reported": "Signalé", "comm2.save": "Enregistrer", "comm2.reply": "Répondre",
  };
  const ar = {
    appName: "هاما 2026",
    ...
    "st.bestThirds": "أفضل أصحاب المركز الثالث", "st.qualifies": "متأهل", "ko.tab": "الإقصائيات", "ko.groups": "المجموعات", "ko.empty": "يظهر الجدول بعد انتهاء دور المجموعات.", "ko.provisional": "مبدئي — بناءً على الترتيب الحالي.",
    "profile.title": "الملف الشخصي", "profile.logout": "تسجيل الخروج",
    "profile.changeName": "تغيير الاسم", "profile.changePhoto": "تغيير الصورة", "profile.theme": "المظهر", "profile.share": "مشاركة", "profile.shareHint": "اضغط مطوّلاً على الصورة لحفظها أو مشاركتها.",
    ...
    "stat.totalPoints": "مجموع النقاط", "stat.exact": "مضبوط", "stat.difference": "فارق الأهداف", "stat.outcomes": "النتائج", "stat.hitRate": "الإصابة", "stat.pts4": "(4 نقاط)",
    ...
    "champ.actual": "البطل الفعلي:", "champ.correct": "صحيح — حصلت على المكافأة! 🏆", "champ.wrong": "اختيار خاطئ.", "champ.race": "سباق البطل",
    ...
    "comm2.post": "نشر", "comm2.empty": "لا توجد منشورات بعد. كن أول من ينشر!", "comm2.comments": "تعليقات", "comm2.addComment": "أضف تعليقاً…", "comm2.new": "جديد", "comm2.top": "الأعلى", "comm2.editL": "تعديل", "comm2.report": "إبلاغ", "comm2.reported": "تم الإبلاغ", "comm2.save": "حفظ", "comm2.reply": "رد",
  };
  const dict = { en, fr, ar };
